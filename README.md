...
This project is like the title suggest it is an RC plane full fledged with remote control Ardu pilot as the backbone, but with an addon to assieted navigation and autonomus. Ardupilot offer bare bone navigation but i wanted more like detecting nervous beginner, lost pilot, etc.  
...
![Alt text](RcPlaneCad/Final-Render-2.png)

---

## Wiring

Here is the wiring under the hood:void vga_draw_line(int x1, int x2, int y1, int y2, unsigned char color){


   
}

![Alt text](Circut-Diagram/Screenshot%202026-03-24%20170510.png)
...
Due to unforeseen circumtances even though i put in all of the work in the wiring, cadding, and part compatilbity testing. I am no longer able to make the plane.
